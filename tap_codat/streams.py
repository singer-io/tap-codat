...
companies = Companies("companies", ["id"], "/companies", replication_method='FULL_TABLE')
all_streams = [
    companies,
    Paginated("accounts",
          ["id", "companyId"],
    ...
    Basic("bank_statements",
          ...
          substreams=[BankStatementLines(
              ...
              None, replication_method="FULL_TABLE")]),
    Paginated("bills",
          ["id", "companyId"],
    ...
    Basic("company_info",
          ...
          returns_collection=False,
          parent=companies,
          replication_method="FULL_TABLE"),  # Not filterable
